...
class AccountInfoRequest extends BaseRequest
{
     ...
     */
    public function setAccountType(string $accountType): AccountInfoRequest
    {
     ...
     * @return AccountInfoRequest
     */
    public function setPayPass(string $payPass): AccountInfoRequest
    {
